import { Mail, Phone, MapPin, GraduationCap, Code, User, Moon, Sun } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center p-6 transition-colors duration-500 ease-in-out
        ${darkMode ? "bg-gray-900 text-gray-100" : "bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500"}`}
    >
      <div
      ...
      >
        ...
        >
          ...
          <button
            onClick={toggleTheme}
            className="mt-4 flex items-center gap-2 px-4 py-2 rounded-lg bg-white/20 hover:bg-white/30 transition duration-300"
          >
          ...
          <div className="mt-6 space-y-3 text-sm w-full">
            <div className="flex items-center gap-2">
              <Mail size={16} />
              <span>trirostingy@gmail.com</span>
            </div>
            <div className="flex items-center gap-2">
              <Phone size={16} />
              <span>+62 895 3921 60450</span>
            </div>
            <div className="flex items-center gap-2">
              <MapPin size={16} />
        ...
        <div className="col-span-2 p-8 space-y-8">
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-2">
              {["React", "Vite", "Tailwind CSS", "Node.js", "Git", "REST API"].map(
                (skill) => (
                  <span
                    key={skill}
